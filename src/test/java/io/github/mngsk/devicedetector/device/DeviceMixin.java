...
public class DeviceMixin {
	...
	public static class Builder {
      ...
      SHORT_BRAND_NAMES.put("36", "360");
			...
			SHORT_BRAND_NAMES.put("4A", "Aligator");
			SHORT_BRAND_NAMES.put("3A", "AllDocube");
      ...
      SHORT_BRAND_NAMES.put("C0", "Clout");
      ...
      SHORT_BRAND_NAMES.put("3C", "Contixo");
			...
			SHORT_BRAND_NAMES.put("D6", "Divisat");
			...
			SHORT_BRAND_NAMES.put("D8", "Droxio");
      ...
      SHORT_BRAND_NAMES.put("K9", "Kooper");
      ...
      SHORT_BRAND_NAMES.put("K8", "Kuliao");
      ...
      SHORT_BRAND_NAMES.put("LZ", "Lesia");
      ...
      SHORT_BRAND_NAMES.put("LS", "MLS");
			...
			SHORT_BRAND_NAMES.put("6M", "Mystery");
      SHORT_BRAND_NAMES.put("1R", "Multilaser");
      ...
      SHORT_BRAND_NAMES.put("0N", "Newman");
      ...
      SHORT_BRAND_NAMES.put("4P", "Philco");
			SHORT_BRAND_NAMES.put("1P", "Phicomm");
      ...
      SHORT_BRAND_NAMES.put("2P", "Prixton");
			SHORT_BRAND_NAMES.put("P6", "Proline");
      ...
      SHORT_BRAND_NAMES.put("P8", "PocketBook");
			...
			SHORT_BRAND_NAMES.put("P7", "Protruly");
			SHORT_BRAND_NAMES.put("P1", "ProScan");
			SHORT_BRAND_NAMES.put("PU", "PULID");
			SHORT_BRAND_NAMES.put("QB", "Q.Bell");
      ...
      SHORT_BRAND_NAMES.put("RE", "Realme");
      SHORT_BRAND_NAMES.put("R8", "RED");
      SHORT_BRAND_NAMES.put("R9", "Ravoz");
			SHORT_BRAND_NAMES.put("RZ", "Razer");
			...
			SHORT_BRAND_NAMES.put("R7", "Ritzviva");
			SHORT_BRAND_NAMES.put("R5", "Ross&Moor");
			SHORT_BRAND_NAMES.put("R2", "R-TV");
			SHORT_BRAND_NAMES.put("RG", "RugGear");
			SHORT_BRAND_NAMES.put("RU", "Runbo");
			SHORT_BRAND_NAMES.put("RY", "Ryte");
			...
			SHORT_BRAND_NAMES.put("7S", "Shift Phones");
      ...
      SHORT_BRAND_NAMES.put("0S", "SEMP TCL");
      ...
      SHORT_BRAND_NAMES.put("X2", "Soundmax");
			SHORT_BRAND_NAMES.put("8S", "Soyes");
			SHORT_BRAND_NAMES.put("SP", "Spice");
			SHORT_BRAND_NAMES.put("6S", "Spectrum");
      SHORT_BRAND_NAMES.put("9S", "Sugar");
			SHORT_BRAND_NAMES.put("5S", "Sunvell");
      ...
      SHORT_BRAND_NAMES.put("0W", "Swipe");
      ...
      SHORT_BRAND_NAMES.put("T0", "TD Systems");
      ...
      SHORT_BRAND_NAMES.put("TW", "TWM");
			...
			SHORT_BRAND_NAMES.put("U1", "Uhans");
			SHORT_BRAND_NAMES.put("UG", "Ugoos");
			...
			SHORT_BRAND_NAMES.put("V9", "Vsun");
			SHORT_BRAND_NAMES.put("V8", "Vesta");
			...
			SHORT_BRAND_NAMES.put("1V", "Vontar");
			SHORT_BRAND_NAMES.put("VG", "Vorago");
			SHORT_BRAND_NAMES.put("2V", "Vorke");
			SHORT_BRAND_NAMES.put("V1", "Voto");
			SHORT_BRAND_NAMES.put("VO", "Voxtel");
			SHORT_BRAND_NAMES.put("VF", "Vodafone");
      SHORT_BRAND_NAMES.put("VM", "Vodacom");
      SHORT_BRAND_NAMES.put("V0", "VKworld");
			SHORT_BRAND_NAMES.put("VY", "Voyo");
			...
			SHORT_BRAND_NAMES.put("YO", "Yota");
			SHORT_BRAND_NAMES.put("YT", "Ytone");
			SHORT_BRAND_NAMES.put("YX", "Yxtel");
			SHORT_BRAND_NAMES.put("ZE", "Zeemi");
			SHORT_BRAND_NAMES.put("ZK", "Zenek");
			SHORT_BRAND_NAMES.put("ZF", "Zfiner");
			SHORT_BRAND_NAMES.put("ZO", "Zonda");
			SHORT_BRAND_NAMES.put("ZI", "Zidoo");
      ...
      SHORT_BRAND_NAMES.put("XS", "Xshitou");
