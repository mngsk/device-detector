...
public abstract class AbstractTest {
	...
	protected void fixtures(GenericFixture fixture) {
		...
		assertEquals(fixture.getOperatingSystem(),
				d.getOperatingSystem().orElse(null),
				() -> debug(fixture.getUserAgent(),
						fixture.getOperatingSystem(),
						d.getOperatingSystem().orElse(null)));
		assertEquals(fixture.getClient(), d.getClient().orElse(null),
				() -> debug(fixture.getUserAgent(), fixture.getClient(),
						d.getClient().orElse(null)));
		assertEquals(fixture.getDevice(), d.getDevice().orElse(null),
				() -> debug(fixture.getUserAgent(), fixture.getDevice(),
	...
	public String debug(String userAgent, Object expected, Object actual) {
		...
		try {
			sb.append("\nexpected: ")
					.append(this.objectMapper.writeValueAsString(expected));
			sb.append("\n  actual: ")
					.append(this.objectMapper.writeValueAsString(actual));
		} catch (Exception e) {
		}
		return sb.toString();
	}
