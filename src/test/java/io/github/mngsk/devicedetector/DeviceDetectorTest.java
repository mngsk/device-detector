...
public class DeviceDetectorTest {
	...
	public static void beforeAll() {
		DD = new DeviceDetectorBuilder().enableEverything().build();
	}

	@Test
	public void nonNullBuild() {
		assertNotNull(DD);
	}
	...
	public void magicMethods() {
		String userAgent = "Mozilla/5.0 (Linux; Android 4.4.2; Nexus 4 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.136 Mobile Safari/537.36";
	...
	public void operatingSystem() {
		...
		OperatingSystem expected = new OperatingSystem("Windows", "Windows",
				"x64", "7");
	...
	public void touchEnabled() {
		String userAgent = "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; ARM; Trident/6.0; Touch; ARMBJS)";
		Detection d = DD.detect(userAgent);
