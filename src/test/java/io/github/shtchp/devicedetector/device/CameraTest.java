...
public class CameraTest {
  ...
  public static void beforeAll() {
    ...
    String fixtureFile = "fixtures/device/camera.yml";
    InputStream inputStream = CameraTest.class.getClassLoader().getResourceAsStream(fixtureFile);
    ...
    DD = new DeviceDetector.DeviceDetectorBuilder().disableEverything().enableCameras().build();
  }
