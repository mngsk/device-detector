...
public class BotTest {
  ...
  public static void beforeAll() {
    ...
    InputStream inputStream = BotTest.class.getClassLoader().getResourceAsStream(fixtureFile);
    CollectionType listType =
        objectMapper.getTypeFactory().constructCollectionType(List.class, BotFixture.class);
    try {
    ...
    DD = new DeviceDetector.DeviceDetectorBuilder().disableEverything().enableBots().build();
  }
