...
public class BrowserTest {
  ...
  public static void beforeAll() {
    ...
    InputStream inputStream = BrowserTest.class.getClassLoader().getResourceAsStream(fixtureFile);
    CollectionType listType =
        objectMapper.getTypeFactory().constructCollectionType(List.class, BrowserFixture.class);
    try {
    ...
    DD = new DeviceDetector.DeviceDetectorBuilder().disableEverything().enableBrowsers().build();
  }
