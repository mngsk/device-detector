...
public class PersonalInformationManagerTest {
  ...
  public static void beforeAll() {
    ...
    String fixtureFile = "fixtures/client/pim.yml";
    InputStream inputStream =
        PersonalInformationManagerTest.class.getClassLoader().getResourceAsStream(fixtureFile);
    ...
    DD =
        new DeviceDetector.DeviceDetectorBuilder().disableEverything().enablePersonalInformationManagers().build();
  }
