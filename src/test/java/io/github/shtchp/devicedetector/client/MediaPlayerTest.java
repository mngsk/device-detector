...
public class MediaPlayerTest {
  ...
  public static void beforeAll() {
    ...
    String fixtureFile = "fixtures/client/mediaplayer.yml";
    InputStream inputStream =
        MediaPlayerTest.class.getClassLoader().getResourceAsStream(fixtureFile);
    ...
    DD = new DeviceDetector.DeviceDetectorBuilder().disableEverything().enableMediaPlayers().build();
  }
